...
def estrategiaMelhorVizinhoNaoTabu(solucao, tabuTable, tabuTenure, iteraction, bestValue):
...
def randomReestart(solucao=False, reestarts = 200):
    if not solucao:
...
def construcaoRepetida(repeat = 4):
    bestSolution = gulosoK(k=3, full=True)
